...
parser.add_argument("--stimgdir", default="/workspace/fair-distill/data/stdata/st_images", type=str, help='path to save the generated images from student generator')
parser.add_argument("--stlatdir", default="/workspace/fair-distill/data/stdata/st_latents", type=str, help='path to save the latents')
parser.add_argument("--teimgdir", default="/workspace/fair-distill/data/stdata/te_images", type=str, help='path to save the generated images from teacher generator(for same latents)')
parser.add_argument("--model_checkpoint", default="/workspace/fair-distill/checkpoints/student_GAN.pt", type=str, help='Checkpoint file along with full path')
...
def main():
    ...
    model_g = Generator(256, 32, 512, 128, 3).cuda()
    ...
    for img_num in range(args.num):
        ...
        z = np.load('/workspace/fair-distill/data/disttrain/s_latentsz/29918.npy')
